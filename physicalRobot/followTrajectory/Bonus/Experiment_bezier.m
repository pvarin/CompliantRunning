function [output_data] = Experiment_bezier( angle1_init, angle2_init, pts_foot, traj_time, buffer_time, pts_cur1, pts_cur2, gains, duty_max)
    figure(1);  clf;       
    a1 = subplot(421);
    h1 = plot([0],[0]);
    h1.XData = []; h1.YData = [];
    ...
    function my_callback(new_data)
        ...
        xdes = new_data(:,16); % current
        ydes = new_data(:,17); % current
